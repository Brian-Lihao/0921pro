...
def write_png(terrain_cost_map=None, rgb_terrain_cost_map=None, center=None, targets=None, paths=None, path=None,
              others=None, file="/test_terrain_cost_map.png"):
    dis = 2
    if rgb_terrain_cost_map is not None:
        terrain_cost_map_fig = rgb_terrain_cost_map
    else:
    ...
    if center is not None:
        ...
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 2] = 255
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 1] = 0
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 0] = 0
    if targets is not None and len(targets)>0:
        ...
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 2] = 0
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 1] = 255
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 0] = 0
    if others is not None:
        ...
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 2] = 0
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 1] = 255
        terrain_cost_map_fig[all_points[:, 0], all_points[:, 1], 0] = 255
    if path is not None:
        ...
        all_pts = np.concatenate((all_pts + np.array([0, -1], dtype=int), all_pts + np.array([1, 0], dtype=int),
                                  ...
                                  all_pts), axis=0)
        terrain_cost_map_fig[all_pts[:, 0], all_pts[:, 1], 0] = 0
        terrain_cost_map_fig[all_pts[:, 0], all_pts[:, 1], 1] = 255
